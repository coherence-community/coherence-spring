...
class EventHandlerTests {
	...
	public static class EventInfo {
		final EntryEvent.Type type;
		final boolean sync;

		EventInfo(EntryEvent.Type type, boolean sync) {
			this.type = type;
			this.sync = sync;
		}
		...
		public final boolean equals(Object o) {
			...
			return this.sync == eventInfo.sync && this.type == eventInfo.type;
		}

		@Override
		public int hashCode() {
			int result = Objects.hashCode(this.type);
			result = 31 * result + Boolean.hashCode(this.sync);
			return result;
		}
	}
