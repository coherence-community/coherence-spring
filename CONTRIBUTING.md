...
[Oracle Contributor Agreement](https://oca.opensource.oracle.com/) (OCA). If you think you already signed the OCA previously, check if you're listed in the [directory of contributors](https://oca.opensource.oracle.com/?ojr=contrib-list).
