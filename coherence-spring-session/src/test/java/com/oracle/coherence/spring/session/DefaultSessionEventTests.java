...
/**
 * Ensures that the expected SessionEvents are fired - using the default cache.
 *
 * @author Gunnar Hillert
 */
@DirtiesContext
@SpringJUnitWebConfig
public class DefaultSessionEventTests extends AbstractSessionEventTests {

	public DefaultSessionEventTests() {
		super.expectedCacheName = CoherenceIndexedSessionRepository.DEFAULT_SESSION_MAP_NAME;
	}
