...
|*4.2.x*          | `17`, `21`      | `24.03`      | N/A                     | `6.x` | `3.3.x` | ✔       | `4.2.x`
|*4.1.x*          | `17`, `21`      | `24.03`      | N/A                     | `6.x` | `3.2.x` | ✔       | `main`
|*3.3.x*          | `11`, `17`, `21`| `22.06`      | `14.1.2`, `14.1.1.2206` | `5.x` | `2.x`   |         | `3.3.x`
|===
...
only support the jakarta namespace. Once commercial edition that supports jakarta namespace gets published
it will be supported by Coherence Spring project. Commercial editions compatible with Coherence Spring 3.x are
