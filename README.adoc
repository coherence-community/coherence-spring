:4x-version: 4.0.0-SNAPSHOT
:snapshot-version: 3.3.2-SNAPSHOT
...
|*{4x-version}* | {website}{4x-version}[Website] |{website}{4x-version}/refdocs/reference/html/index.html[Multi-page HTML] |{website}{4x-version}/refdocs/reference/htmlsingle/index.html[Single-page HTML] | {website}{4x-version}/refdocs/reference/pdf/coherence-spring-reference.pdf[PDF] | {website}{4x-version}/refdocs/api/index.html[API Doc.]
|=======
