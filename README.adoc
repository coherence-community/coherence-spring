:main-release-version: 4.0.0-SNAPSHOT
...
|*{main-snapshot-version}* | `17` | `23.03`      | `6.x` | `3.x` | ✔       | `main`
|*{3x-release-version}*    | `11` | `22.06`      | `5.x` | `2.x` |         | `3.3.3`
|*{3x-snapshot-version}*   | `11` | `22.06`      | `5.x` | `2.x` |         | `3.3.x`
|===
