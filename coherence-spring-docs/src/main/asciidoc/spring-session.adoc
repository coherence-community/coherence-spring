...
NOTE: Coherence Spring {coherence-spring-version} is using the Javax (Java EE) namespace. For Jakarta EE, please use
Coherence Spring 4.x or later. Therefore, chose the appropriate version of the Servlet container accordingly.
