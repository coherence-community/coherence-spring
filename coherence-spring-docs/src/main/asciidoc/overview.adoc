...
{coherence-spring-website}//history.html[Change History] as well as the {github-releases}[GitHub Releases] page.
...
<<spring-boot.adoc#spring-boot>> chapter next. The reference documentation makes a distinction between
