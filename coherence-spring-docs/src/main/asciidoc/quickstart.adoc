...
In order to get started, please checkout the code from the https://github.com/ghillert/coherence-spring-demo[Coherence Spring Demo]
GitHub repository.
...
This repository contains a Maven project consisting of 3 modules. The first two Maven modules are essentially variations of
