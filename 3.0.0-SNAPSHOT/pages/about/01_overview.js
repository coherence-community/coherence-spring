...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Spring Boot</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/about/06_spring-session"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
<v-icon class="xxx-large">fa-database</v-icon>
</v-avatar>
</v-layout>
<div class="px-3">
<v-divider class="indigo lighten-4"/>
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Spring Session</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Spring&#8217;s Session Abstraction</p>
</v-card-text>
</v-card>
</v-flex>
<v-flex xs12 sm4 lg3>
...
<v-layout align-center justify-center class="">
<v-avatar size="150px">
<v-icon class="xxx-large">text_snippet</v-icon>
</v-avatar>
</v-layout>
<div class="px-3">
<v-divider class="indigo lighten-4"/>
...
<v-card-title primary class="headline layout justify-center">
<span style="text-align:center">Single Page HTML</span>
</v-card-title>
<v-card-text class="caption">
<p></p>
<p>Reference Documentation.</p>
...
<v-layout align-center justify-center class="">
<v-avatar size="150px">
<v-icon class="xxx-large">picture_as_pdf</v-icon>
</v-avatar>
</v-layout>
<div class="px-3">
<v-divider class="indigo lighten-4"/>
...
<v-layout align-center justify-center class="">
<v-avatar size="150px">
<v-icon class="xxx-large">code</v-icon>
</v-avatar>
</v-layout>
<div class="px-3">
<v-divider class="indigo lighten-4"/>
...
<v-card-text class="caption">
<p></p>
<p>Browse the Coherence Spring JavaDocs.</p>
</v-card-text>
</v-card>
</v-flex>
</v-layout>
